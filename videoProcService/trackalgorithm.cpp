                                     ...
                                     int videoSrc)
{
    ...
    {
        static Scalar colorTargetTag(250,20,20);
        int x = matchRect.width/2;
        int y = matchRect.height/2;

        line(tempMat,Point(x-40,y-20) , Point(x-40,y-40) ,colorTargetTag , 2 ,8 ,0);
        line(tempMat,Point(x-40,y-40) , Point(x-20,y-40) ,colorTargetTag , 2 ,8 ,0);

        line(tempMat,Point(x+20,y-40) , Point(x+40,y-40) ,colorTargetTag , 2 ,8 ,0);
        line(tempMat,Point(x+40,y-40) , Point(x+40,y-20) ,colorTargetTag , 2 ,8 ,0);
